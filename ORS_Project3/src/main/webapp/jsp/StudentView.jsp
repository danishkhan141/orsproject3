            ...
            <div class="card" style="border-radius: 2rem;">
              <div class="card-body p-5">
                  ...
                  <%
								...
								if (id > 0) {
								%>
                    <h4 style="text-shadow:black;"><u><b>UPDATE STUDENT</b></u></h4>
								<%
									} else {
								%>
                    <h4 style="text-shadow:black;"><u><b>ADD STUDENT</b></u></h4>
								<%
									}
								%>
							</div>
...
<%
        ...
        <div class="input-group">
        	<div class="input-group-prepend">
         	...
         	<font color="red" style="padding-right: 5.7cm; font-size: .4cm;"><%=ServletUtility.getErrorMessage("email", request)%></font>
		...
		<br>
  		<div class="input-group">
            ...
            <input type="text" class="form-control" name="mobileNo" placeholder="Enter Mobile No." value="<%=DataUtility.getStringData(dto.getMobileNo())%>">
         	...
         	<font color="red" style="padding-right: 4.9cm; font-size: .4cm;"><%=ServletUtility.getErrorMessage("mobileNo", request)%></font>
               ...
               <br>
        			...
        			<%
						if (id > 0) {
					%>
                    <input type="submit" class="btn btn-primary" name="operation" value="<%=StudentCtl.OP_UPDATE%>">
                    <input type="submit" class="btn btn-secondary" name="operation" value="<%=StudentCtl.OP_CANCEL%>">
                    
                    <%
						} else {
					%>
					<input type="submit" class="btn btn-primary" name="operation" value="<%=StudentCtl.OP_SAVE%>">
                    <input type="submit" class="btn btn-secondary" name="operation" value="<%=StudentCtl.OP_RESET%>">
                    <%
						}
					%>
                  </div>
